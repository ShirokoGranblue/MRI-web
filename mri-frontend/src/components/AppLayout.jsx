...
import { visibleNavigation } from '../lib/role-utils.js';
...
export default function AppLayout() {
  const { username, displayName, roles, isPatient, loggedIn, logout, busyKey } = useApp();
  const navItems = visibleNavigation(roles);
  return (
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-foot">
          ...
          <span>{displayName || username || '未登录'} · {isPatient ? '患者' : '医生'}</span>
        </div>
      </aside>
